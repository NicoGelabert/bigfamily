...
$toemails[] = array(
				'email' => 'form@bigfamily.com.ar', // Your Email Address
				'name' => 'Big Family 2' // Your Name
			);
...
$fromemail = array(
				'email' => 'form@bigfamily.com.ar', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Big Family' // Company Name
			);
...
/* Add your SMTP Codes after this Line */                  // Enable verbose debug output
    $mail->isSMTP();                                      // Set mailer to use SMTP
    $mail->Host = 'mail.bigfamily.com.ar';  // Specify main and backup SMTP servers
    $mail->SMTPAuth = true;                               // Enable SMTP authentication
    $mail->Username = 'form@bigfamily.com.ar';                 // SMTP username
    $mail->Password = 'Form2021*';                           // SMTP password
...
$message = array(
	'success'			=> 'Recibimos tu correo. Pronto vas a recibir los descuentos que solicitaste',
	'error'				=> 'No pudimos enviar tu mail.',
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$html_title	= !empty( $submits['html_title'] ) ? $submits['html_title'] : 'Nuevo Lead';
	...
	$ar_subject	= !empty( $submits['ar_subject'] ) ? $submits['ar_subject'] : 'Gracias por tu Email';
	$ar_title	= !empty( $submits['ar_title'] ) ? $submits['ar_title'] : 'Qué bueno saber de vos!';
	...
	$ar_footer	= !empty( $submits['ar_footer'] ) ? $submits['ar_footer'] : 'Copyrights &copy; ' . date('Y') . ' <strong>Big Family</strong>. Todos los derechos reservados.';

	$mail->Subject = !empty( $submits['subject'] ) ? $submits['subject'] : 'Nuevo correo desde Big Family';
